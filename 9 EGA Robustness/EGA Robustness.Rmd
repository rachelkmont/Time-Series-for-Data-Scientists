...
### Structure of BFI-2 at Time 1 and Time 2

#### 1. Subset the data into time 1 and time 2

Creating Subsets for Time 1 and Time 2 Data
...
#### 2. Subset the time 1 and time 2 into younger (between 18 and 25) and middle-aged (between 26-50) age groups
...
#### 3. Set up the theoretical structure (use `trait` in the `bfi2_codebook`)
...
#### 4. Using the theoretical structure, test for invariance between the time 1 and time 2 data of the *younger* age group (don't forget to set a seed *in* the function)
...
#### 5. Are the time points invariant for the *younger* age group? (Visualize and summarize results. Point out any items that were invariant)
...
##### 6. Using the theoretical structure, test for invariance between the time 1 and time 2 data of the *middle-aged* age group (don't forget to set a seed *in* the function)
...
#### 7. Are the time points invariant for the *younger* age group? (Visualize and summarize results. Point out any items that were invariant)
...
#### 9. Now, using time 1, perform invariance between the two age groups using the theoretical structure
...
#### 10. Is measurement invariant between the two groups? (Visualize and summarize results. Point out any items that were invariant)
...
#### 11. Check for any redundancies at time 1 in the younger age group. Report any redundancies greater than 0.25
...
#### 12. Check for any redundancies at time 1 in the middle-aged age group. Report any redundancies greater than 0.25
